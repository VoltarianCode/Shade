...
public class DetailActivity extends ActionBarActivity {
    ...
    public static class DetailFragment extends Fragment {
        ...
        private static final String FORECAST_SHARE_HASHTAG = " #fromShadeWeatherApp";
        ...
        private Intent createShareForecastIntent() {
            ...
            String location = "Location: " + (preferences.getString(getString(R.string.pref_location_key),
                    getString(R.string.pref_location_default))).toUpperCase();
